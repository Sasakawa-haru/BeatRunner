...
const float Lane::laneWidth = 2.3f;
    ...
    , laneType_(LaneType::Unknown)
{
    ...
    switch (laneIndex_) {
    case 0: laneType_ = LaneType::Lane1; break;//1ƒŒ[ƒ“
    ...
    case 5: laneType_ = LaneType::Lane6; break;//ã
    case 6: laneType_ = LaneType::Lane7; break;//‰º
